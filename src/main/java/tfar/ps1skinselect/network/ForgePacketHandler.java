...
import tfar.ps1skinselect.PS1SkinSelect;
import tfar.ps1skinselect.network.client.S2CModPacket;
import tfar.ps1skinselect.network.server.C2SModPacket;
...
public class ForgePacketHandler {
    ...
    public static SimpleChannel INSTANCE =  NetworkRegistry.newSimpleChannel(PS1SkinSelect.id("packet"), () -> "1.0", s -> true, s -> true);
